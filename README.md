...
Сбор данных: поиск адресов объектов инфрастурктуры и определение их геолокации с помощью Яндекс.Геокодер.

Анализ:

Формулирование и проверка гипотез: https://github.com/Lemekhova/Analysis_of_Housing_Prices/blob/main/Hypothese_Infra.ipynb
