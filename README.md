**Исследование влияния окружающей инфраструктуры на стоимость аренды квартир в Москве.**
...
Сбор данных: поиск адресов объектов инфрастурктуры и определение их геолокации с помощью Яндекс.Геокодер [пример (Mall_Geolocation)](Mall_Geolocation.ipynb)

[Обработка и анализ данных (EDA)](EDA.ipynb)

[Формулирование и проверка гипотез (Hypothese_Infra)](Hypothese_Infra.ipynb)

[Предсказание стоимости аренды. Построение и сравнение моделей (4_этап_ML)](4_этап_ML.ipynb)
